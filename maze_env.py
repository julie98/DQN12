...
class Maze(tk.Tk):
    ...
    def _build_maze(self):
        ...
        hell2_center = origin + np.array([UNIT * 0, UNIT * 7])
        self.hell2 = self.canvas.create_rectangle(
            hell2_center[0] - 15, hell2_center[1] - 15,
            hell2_center[0] + 15, hell2_center[1] + 15,
            fill='black')

        hell3_center = origin + np.array([UNIT * 2, UNIT * 9])
